module.exports = async function (context, req) {
    ...
    if (!Array.isArray(todos)) {
        context.res = { status: 400, headers: { 'Content-Type': 'application/json' }, body: { error: 'Expected an array of todos' } };
        return;
    }
    ...
    try {
        ...
        const body = { message: 'Update todos', content, ...(sha && { sha }) };
        ...
        context.log.error('save-todos:', e.message);
